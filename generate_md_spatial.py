...
# --------------------------------------------------------------------------
QEA_PATH = r"c:/Users/mosquera/Documents/302298/ea-docs/data/Floods2018_RN3_UML_Spatial.qea"

OUTPUT_DIR = "docs/CA_UOM/tables_spatial"
...
def main():
    ...
    if not tables:
        print("No spatial tables found with Object_Type = 'Class'.")
    ...
    for table_id, table_name, table_note in tables:
        ...
        filename = "spatial_" + slug(table_name) + ".md"
        filepath = os.path.join(OUTPUT_DIR, filename)
        with open(filepath, "w", encoding="utf-8") as f:
            f.write("\n".join(content))

        toc_entries.append(f"tables_spatial/spatial_{slug(table_name)}")
