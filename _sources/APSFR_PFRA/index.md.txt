...
```{toctree}
:maxdepth: 2
:caption: APSFR Descriptive tables
:glob:
...
```{toctree}
:maxdepth: 2
:caption: APSFR Spatial table
:glob:

tables_spatial/spatial_RiskZone
```
...
```{toctree}
:maxdepth: 2
:caption: PFRA Descriptive tables
:glob:

tables/PreliminaryFloodRiskAssessment
tables/PreliminaryFloodRiskAssessment_FloodEvent
...
```{toctree}
:maxdepth: 2
:caption: PFRA Spatial table
:glob:

tables_spatial/spatial_HazardArea
```